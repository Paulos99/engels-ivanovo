...
export const siteConfig: SiteConfig = {
  ...
  links: {
    ...
    route: "https://yandex.ru/maps/?rtext=~56.978611,40.981389&rtt=auto",
  },
  features: {
    dogFriendly: true,
  },
  seo: {
    ...
    url: "https://paulos99.github.io/engels-ivanovo",
  },
  copy: {
    baristaHelp:
    ...
    philosophy: [
      ...
      "Спешелти-кофе и авторская кухня.",
    ...
    food: "Авторская кухня: завтраки, основные блюда, сэндвичи, десерты. О наличии сезонных блюд расскажет команда кофейни.",
    space:
